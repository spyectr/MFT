...
cue.cue_option={'SST','PV','VIP'}; % populations affected by the cue, among: 'Pyr','SST','PV','VIP'
cue.cue_stat={'mean','mean','mean'}; % for each population above, choose type of cue: 
% 'gaussian'=increase quenched variance of afferent currents as in Mazzucato et al., 2019
% 'mean'=change mean afferent current
cueset={[0,0.05],[0,0.05],[0,0.05]}; % for each cue_option, write the set of values in each MFT RUN
